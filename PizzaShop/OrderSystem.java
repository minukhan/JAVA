...
class OrderSystem {
    ...
    int choice(int n){
        ...
        }catch (InputMismatchException  e){//예외상황이 발생시 이곳을 수행한다.
            userChoise = 0;
    ...
    void intro(){
        System.out.println(line);
        System.out.println("");
        System.out.println("Welcome to 민욱's 피자가게");
    ...
    void goodbye(){
        System.out.println("");
        System.out.println("Thank you for visiting 민욱's 피자가게!");
        System.out.println("리뷰 잘써주헤요 ㅎㅎ!");
        System.out.println("");
        System.out.println(line);
    }
}